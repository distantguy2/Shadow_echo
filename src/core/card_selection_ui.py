...
class CardSelectionUI:
    ...
    # Thay thế hàm handle_event hiện tại
    ...
    def draw(self):
        ...
        # Draw time remaining
        time_text = self.title_font.render(f"Chọn thẻ bài: {int(self.time_left)}s", True, (255, 255, 255))
        time_rect = time_text.get_rect(center=(self.screen_width / 2, 50))
        self.screen.blit(time_text, time_rect)
        
        # Draw instructions
        instructions = self.small_font.render("Nhấp chuột để chọn thẻ - ENTER để xác nhận", True, (200, 200, 200))
    ...
    def _get_card_color(self, card_type: str) -> Tuple[int, int, int]:
    ...
    def _draw_confirm_button(self):
        ...
        confirm_text = self.small_font.render("XÁC NHẬN", True, (255, 255, 255))
